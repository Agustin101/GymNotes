        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExerciseUnitId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Exercise_ExerciseUnit_ExerciseUnitId",
                        column: x => x.ExerciseUnitId,
                        principalTable: "ExerciseUnit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TotalSeries = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutExerciseSerie", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkoutExerciseSerie_ExerciseUnit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "ExerciseUnit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkoutExerciseSerie_WorkoutExercise_WorkoutExerciseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercise_ExerciseUnitId",
                table: "Exercise",
                column: "ExerciseUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutExerciseSerie_UnitId",
                table: "WorkoutExerciseSerie",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkoutExerciseSerie_WorkoutExerciseId",
                table: "WorkoutExerciseSerie",
